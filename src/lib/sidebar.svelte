...
<ul class="menu px-4 py-0 ">
        <li>
		<Sidebaritem name="Dashboard" route="/" />
        </li> <li>
		<Sidebaritem name="Inventory" route="/inventory/" />
        </li>
        <li>
		<Sidebaritem name="Invoices" route="/invoices/" />
        </li>
        <li>
        ...
        <li>
    	<Sidebaritem name="Settings" route="/settings/" />
        </li>
</ul>
</aside>
</div>
